...
def test_ducks_every_playing_app_to_the_default() -> None:
    ...
    muter = _FakeMuter(_linux_config(), volumes={90: 0.85, 95: 1.0})
...
def test_quieter_stream_is_not_ducked_up() -> None:
    ...
    muter = _FakeMuter(_linux_config(duck_volume=0.4), volumes={90: 0.3, 95: 0.2})
...
def test_duck_volume_above_one_is_clamped() -> None:
    ...
    muter = _FakeMuter(_linux_config(duck_volume=40.0), volumes={90: 0.85, 95: 0.9})
